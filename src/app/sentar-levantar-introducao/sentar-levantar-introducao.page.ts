...
@Component({
  ...
  templateUrl: './sentar-levantar-introducao.page.html',
  styleUrls: ['./sentar-levantar-introducao.page.scss'],
})
export class SentarLevantarIntroducaoPage implements OnInit {
  uid:string;
