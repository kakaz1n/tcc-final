(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["flexibilidade-introducao-flexibilidade-introducao-module"], {
    ...
    /***/
    function AhqA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MF17(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FlexibilidadeIntroducaoPage", function () {
        return FlexibilidadeIntroducaoPage;
      });
      /* harmony import */
      ...
      var _raw_loader_flexibilidade_introducao_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./flexibilidade-introducao.page.html */
      "AhqA");
      /* harmony import */


      var _flexibilidade_introducao_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./flexibilidade-introducao.page.scss */
      "7/d5");
      /* harmony import */
      ...
      var FlexibilidadeIntroducaoPage = /*#__PURE__*/function () {
        function FlexibilidadeIntroducaoPage(navCtrl, authService, dadosserv, toastController, db) {
          _classCallCheck(this, FlexibilidadeIntroducaoPage);
        ...
        _createClass(FlexibilidadeIntroducaoPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.authService.userDetails().subscribe(function (res) {
              ...
              if (res !== null) {
                ...
                var a = _this.db.object('usuarios/' + _this.uid + "/dados");

                a.snapshotChanges().subscribe(function (res) {
                  var dados = res.payload.toJSON();
                  var now = Date.now().toString();
                  var dob = new Date(dados['dob']);
                  var a = Math.abs(Date.now() - dob.getTime());
                  _this.idade = Math.floor(a / (1000 * 3600 * 24) / 365);
      ...
      FlexibilidadeIntroducaoPage.ctorParameters = function () {
        return [{
      ...
      FlexibilidadeIntroducaoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function mVKX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FlexibilidadeIntroducaoPageModule", function () {
        return FlexibilidadeIntroducaoPageModule;
      });
      /* harmony import */
      ...
      var _flexibilidade_introducao_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./flexibilidade-introducao-routing.module */
      "tDt2");
      /* harmony import */


      var _flexibilidade_introducao_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./flexibilidade-introducao.page */
      "MF17");

      var FlexibilidadeIntroducaoPageModule = function FlexibilidadeIntroducaoPageModule() {
        _classCallCheck(this, FlexibilidadeIntroducaoPageModule);
      };

      FlexibilidadeIntroducaoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _flexibilidade_introducao_routing_module__WEBPACK_IMPORTED_MODULE_5__["FlexibilidadeIntroducaoPageRoutingModule"]],
    ...
    /***/
    function tDt2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FlexibilidadeIntroducaoPageRoutingModule", function () {
        return FlexibilidadeIntroducaoPageRoutingModule;
      });
      /* harmony import */
      ...
      var _flexibilidade_introducao_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./flexibilidade-introducao.page */
      "MF17");
      ...
      var FlexibilidadeIntroducaoPageRoutingModule = function FlexibilidadeIntroducaoPageRoutingModule() {
        _classCallCheck(this, FlexibilidadeIntroducaoPageRoutingModule);
      };

      FlexibilidadeIntroducaoPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=flexibilidade-introducao-flexibilidade-introducao-module-es5.js.map